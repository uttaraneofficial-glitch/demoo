    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6">
            <motion.div
                ...
                className="bg-surface p-8 rounded-xl shadow-md border border-border max-w-xl w-full"
            >
                        ...
                        return (
                            <button
                                ...
                                className={`flex flex-col items-center text-center p-6 rounded-lg border-2 transition-all ${isSelected
                                        ...
                                        : 'bg-surface text-primary border-border hover:border-text-muted'
                                    }`}
                            >
                                <Icon className={`w-10 h-10 mb-4 ${isSelected ? 'text-background' : 'text-primary'}`} />
