...
public class ExploreService {
    ...
    private String buildGptPrompt(ExploreRequest req, String locationData) {
        return "You are an elite, senior-level market analyst and startup advisor at a top-tier management consulting firm (e.g., McKinsey, BCG). Produce a comprehensive, institutional-grade market analysis for a " + req.getIndustry() +
                ...
                "ANTI-HALLUCINATION GUARDRAIL (CRITICAL): For 'governmentSchemes', you MUST provide ONLY 100% REAL, verified, and currently active real-world government policies, subsidies, or schemes. The 'applyUrl' MUST be the exact, real-world official direct link (e.g., ending in .gov.in). Do NOT invent, guess, or hallucinate any schemes or links. If you are not completely certain of a valid, working scheme and its exact application portal for this specific startup, you MUST return an empty array `[]` for 'governmentSchemes'. It is critical to provide zero fake information to build real trust.\n\n" +
